...
class FileGroup implements TimestampedInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Files\File", mappedBy="fileGroup", cascade={"persist"})
     */
    private $files;
